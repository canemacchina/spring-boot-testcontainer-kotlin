package it.lorenzobugiani.springboottestcontainerkotlin.independent
...
class DeclaringContainerIT1 {

    companion object {
        @Container
        @JvmStatic
        val mongoDBContainer: MongoDBContainer = MongoDBContainer("mongo:4")
